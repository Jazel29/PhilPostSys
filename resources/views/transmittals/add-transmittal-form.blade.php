...
<form action="/addRecord" id="addAddresseeForm" method="POST" class="p-3 needs-validation" onsubmit="event.preventDefault(); showConfirmationModal();">
    ...
    <div class="add-transmittal-form flex">
        <div class="left-section w-1/2">
            <div class="mx-4">          
            <div class="row mt-4">
    <input type="date" name="date_posted" id="date_posted" class="form-control rounded-md text-19" style="border-color:#a0aec0; box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.1);" required placeholder="Select date">
</div>
